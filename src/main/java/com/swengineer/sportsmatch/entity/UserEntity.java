...
public class UserEntity extends BaseEntity {
    ...
    private int userId; // 기존 user_id -> userId로 변경 (CamelCase)

    @Column(name = "team_id", nullable = true) // 외래 키로 사용, 관계 매핑 없이 값만 저장
    ...
    public static UserEntity toSaveEntity(UserDTO userDTO) {
        ...
        userEntity.setTeam_id(userDTO.getTeam_id()); // team_id 값만 설정
